          ...
          >
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="mt-2 inline-flex items-center gap-1.5 font-poppins text-sm font-semibold text-gold-ink hover:text-navy transition-colors"
                >
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <a
                  href={NAP.phoneTel}
                  className="font-poppins text-sm text-navy hover:text-gold-ink transition-colors"
                >
                  {NAP.phone}
                </a>
              </div>
